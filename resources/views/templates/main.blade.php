                ...
                <div class="position-sticky d-flex flex-column">
                    <ul class="nav flex-column">
                        <li class="nav-item text-center">
                            <a href="{{ route('user.profile') }}" class="nav-link py-3 px-0 @if($module == 'profile') active @endif" title="Perfil">
                        ...
                        <li class="nav-item ms-2 mx-md-auto mx-xl-2 overflow-hidden">
                            <a href="/" class="nav-link py-3 py-xl-2 @if($module == 'dashboard') active @endif" title="Dashboard">
                        ...
                        <li class="nav-item ms-2 mx-md-auto mx-xl-2">
                            <a href="{{ route('admin.users.index') }}" class="nav-link py-3 py-xl-2 @if($module == 'users') active @endif" title="Usuarios">
                        ...
                        @can('role_access')
                        <li class="nav-item ms-2 mx-md-auto mx-xl-2">
                            <a href="{{ route('roles.index') }}" class="nav-link py-3 py-xl-2 @if($module == 'roles') active @endif" title="Roles">
                        ...
                        @can('project_access')
                        <li class="nav-item ms-2 mx-md-auto mx-xl-2">
                            <a href="{{ route('projects.index') }}" class="nav-link py-3 py-xl-2 @if($module == 'projects') active @endif" title="Proyectos">
                        ...
                        @can('ticket_access')
                        <li class="nav-item ms-2 mx-md-auto mx-xl-2">
                            <a href="{{ route('tickets.index') }}" class="nav-link py-3 py-xl-2 @if($module == 'tickets') active @endif" title="Tickets">
